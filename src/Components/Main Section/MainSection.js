...
export default function MainSection() {
  return (
    <div className="p-4 mb-bg md:flex md:justify-between md:bg-myImageii md:bg-[#F1EDFD] md:bg-no-repeat md:bg-myPositionii md:bg-mySizeii md:rounded-3xl md:w-[95%] md:m-auto md:py-14">
      <span className="md:grid md:gap-2 md:self-center">
        ...
        <p className="hidden md:block md:border-2 border-[#754DE8] md:bg-white md:text-[#754DE8] md:w-fit md:py-2 md:px-10 md:rounded-2xl md:mt-8 md:font-medium">
          Start Creating
        </p>
      </span>
